...
int main(int argc, char* argv[]) {
    ...
    IterationResult res = run_iteration_NNOp(he, encoded,  vals, args, targetValue);
    if(res.detected)
    {
        args.results_dir = "../../../../resultsNNop";
        ...
        for (size_t bitIndex = 0; bitIndex < bits_to_flip.size() ; bitIndex++) {
            ...
            for (size_t i = 0; i < num_bitFlips; i++) {
                ...
                IterationResult res = run_iteration_NNOp(he, encoded, vals, args, targetValue, iterArgs);
