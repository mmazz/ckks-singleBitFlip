...
def plot_bit(stats, ax=None, label_prefix="", color=colors["red"], scatter=True, xlabel="Bit index", label="Mean $L_2$", size=40, plot_std=False, alpha=1.0, dataType="l2", legend=True):
